...
export class NeynarService {
     ...
     */
    async replyToCast(parentFid, parentHash, text) {
        try {
     ...
     */
    async getUserEthereumAddress(fid) {
    ...
    formatCast(apiCast) {
        ...
        return {
            ...
            embeds: apiCast.embeds?.map((embed) => ({
                url: embed.url,
                title: embed.title,
            ...
            embedded_media: apiCast.embedsMedia?.map((media) => ({
                url: media.url,
                type: media.type,
